document.addEventListener('DOMContentLoaded', function() {
    ...
    // Agregar animación al cambio de sección
    function animateSection(section) {
        contentSections.forEach(sec => sec.classList.remove('active', 'fade-in'));
        document.getElementById(`${section}-content`)?.classList.add('active', 'fade-in');
    }
